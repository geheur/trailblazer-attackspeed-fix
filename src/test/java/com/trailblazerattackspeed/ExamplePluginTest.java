...
public class ExamplePluginTest
{
	...
	{
		setWindowTitle("trailblazer-attackspeed (" + getCurrentGitBranch() + ") RL-" + RuneLiteProperties.getVersion());

		ExternalPluginManager.loadBuiltin(TrailblazerAttackSpeedPlugin.class);
		RuneLite.main(args);
	}
